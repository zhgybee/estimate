...
select ID, YEAR, BRAND, MODEL, ISINSIDE, sum(VOLUME) as 'VOLUME', sum(AMOUNT) as 'AMOUNT', COST, PRICE, PROFITRATE, CODE, SORT, CREATE_USER_ID, CREATE_DATE, (PRICE - COST / 1.16)  as 'PROFIT' from T_SALES group by MODEL, YEAR
